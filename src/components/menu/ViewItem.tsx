...
const ViewItem: React.FC<ViewItemProps> = ({ itemId }) => {
  ...
  return (
    <div className="flex flex-col border-none shadow-none justify-between w-ful md:flex-row items-center md:items-start bg-white p-6 rounded-lg shadow-lg gap-6 max-w-2xl mx-auto ">
      {/* Image Section */}
      {itemData.imageUrl && (
        <img
