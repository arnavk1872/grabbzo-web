// components/Pages/CancellationAndRefundPolicy.tsx
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <ul className="list-disc pl-8 space-y-4 mb-6">
        <li>
          <p className="text-justify">
            Orders can be cancelled within 5 (Five) minutes of placing the
            order. However, on cancellation of an order on your part, no refund
            requests would be entertained.
          </p>
        </li>
        <li>
          <p className="text-justify">
      ...
      <ul className="list-disc pl-8 space-y-4 mb-6">
        <li>
          <p className="text-justify">
            Orders can be cancelled within 5 (Five) minutes of placing the order
            only due to non-availability of the ordered items.
          </p>
        </li>
        <li>
          <p className="text-justify">
      ...
      <p className="text-justify mb-6">
        Please feel free to reach us at: <strong>SUPPORT@GRABBZO.COM</strong>{" "}
